                                    ...
                                    return (
                                        <div className="list-item">
                                            ...
                                            <div className="col address">
                                                <a> {records[item].address ? records[item].address.substr(0, 5) + "..." + records[item].address.substr(records[item].address.length - 3, records[item].address.length) : ""}</a>
                                            </div>
                                            <div className="col">
