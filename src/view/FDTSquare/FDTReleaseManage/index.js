...
import AddLPWhiteListAddr from "./component/AddLPWhiteListAddr";
import RemoveLPWhiteListAddr from "./component/RemoveLPWhiteListAddr";

import AddBLWhiteListAddr from "./component/AddBLWhiteListAddr";
import RemoveBLWhiteListAddr from "./component/RemoveBLWhiteListAddr";
...
const FireLock = (props) => {
    ...
    return (
        <FireLockStyle>
            ...
            {isShowAddlp && <AddLPWhiteListAddr updateData={() => {
                getlpWList()
            }} closeDialog={() => {
                setShowAddlp(false)
            }}/>}
            {isShowRemovelp && <RemoveLPWhiteListAddr updateData={() => {
                getlpWList()
            }} closeDialog={() => {
                setShowRemovelp(false)
            }}/>}

            {isShowAddbl && <AddBLWhiteListAddr updateData={() => {
                getblWList()
            }} closeDialog={() => {
                setShowAddbl(false)
            }}/>}
            {isShowRemovebl && <RemoveBLWhiteListAddr updateData={() => {
                getblWList()
            }} closeDialog={() => {
                setShowRemovebl(false)
            }}/>}
            <h1 className="title">
                FDT Release Manage
            </h1>
