...
import AddWhiteListStyle from "./AddNormalWhiteListStyle";
            ...
            <div className="part3">
                <div className="panel-box">
                    <div className="panel-container">
                        <h3 className="tip">
                            I can have <strong>{maxTwo}</strong> whitelists, I've
                            got <strong>{threeAdminWhiteList.length}</strong> whitelists, I can
                            have <strong>{maxTwo - threeAdminWhiteList.length}</strong> whitelists.
