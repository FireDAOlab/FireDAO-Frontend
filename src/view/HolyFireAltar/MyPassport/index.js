        ...
        <MyPassportStyle>
                ...
                <div className="panel-container user-info" style={{ border: 'none', width: '100%', padding: '0em', margin: '0', boxShadow: 'none' }}>
                    ...
                    <div className="recommender">
                        <div className="left">
                            ...
                            <div className="recommender-info">
                                <div className="pid">
                                    PID
                                    <span className="reputation-data">{myClassPid ? myClassPid : "-"}</span>
                                </div>
                    ...
                    <div className="link-box" style={{ overflow: 'hidden' }}>
                        <div className="flex-box" >
                            ...
                            <div className="website link-item">
            ...
            <div className="panel-box">
                <div className="panel-container">
                    <div className="panel-title sbttit">
                        My SBT
                        <div className='soul'>
                            <p>My SoulAccount</p>
            ...
            <div className="panel-box ">
                <div className="panel-container">
                    <div className="panel-title wallt">
                        My Wallet
                        <div className='wall'>
                            <p>Total Assets</p>
            ...
            <div className="panel-box">
                <div className="panel-container">
                    <div className="panel-title fdtt">
                        My FDT
                        <div className='fdt'>
                            <div className='fff'>
                                <p>FDT</p>
